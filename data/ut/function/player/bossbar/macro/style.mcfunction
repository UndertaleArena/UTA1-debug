...
$execute if score @s shield matches 1.. if score @s bid matches $(Current) run bossbar set p$(Current)_hp color green
$execute if score @s shield matches 1.. if score @s bid matches $(Current) run bossbar set p$(Current)_hp style progress