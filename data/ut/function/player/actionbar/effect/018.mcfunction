...
data modify storage soul ActionList prepend value [{"text":"\uF819\uF817\uF018\uF812"},{"text":"","font":"minecraft:back.state.small","extra":[{"score":{"objective":"hud","name":"timer018"}},{"text":"."},{"score":{"objective":"hud","name":"timer018_ms"}},{"text":"s"}]},{"text":"","font":"minecraft:display","extra":[{"score":{"objective":"hud","name":"timer018"}},{"text":"."},{"score":{"objective":"hud","name":"timer018_ms"}},{"text":"s"}]},{"text":"\uF819\uF815"}]
