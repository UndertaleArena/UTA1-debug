...
data modify storage soul ActionList prepend value [{"text":"\uF819\uF817\uF005\uF812"},{"text":"","font":"minecraft:back.state.small","extra":[{"score":{"objective":"hud","name":"timer005"}},{"text":"."},{"score":{"objective":"hud","name":"timer005_ms"}},{"text":"s"}]},{"text":"","font":"minecraft:display","extra":[{"score":{"objective":"hud","name":"timer005"}},{"text":"."},{"score":{"objective":"hud","name":"timer005_ms"}},{"text":"s"}]},{"text":"\uF819\uF815"}]
