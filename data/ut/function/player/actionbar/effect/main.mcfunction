...
execute if entity @s[tag=effect_vined] run function ut:player/actionbar/effect/045
execute if entity @s[tag=effect_webbed] run function ut:player/actionbar/effect/046
execute if entity @s[tag=effect_flame] run function ut:player/actionbar/effect/047
