...
########Spawn Pos
scoreboard players operation @e[tag=team_attack,scores={maplock=1}] tid = -FirstDefend siegegame
scoreboard players operation @e[tag=team_defend,scores={maplock=1}] tid = -FirstAttack siegegame
tag @a[tag=playing] add tobechosen
execute as @e[tag=team_attack,scores={maplock=1},limit=1] at @s run function ut:game/siege/spawnpoint
execute as @e[tag=team_defend,scores={maplock=1},limit=1] at @s run function ut:game/siege/spawnpoint
