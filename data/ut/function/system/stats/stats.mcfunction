...
execute as @a[team=t1] run tag @s add stats_sort
execute if entity @a[tag=stats_sort] run function ut:system/stats/sort
execute as @a[team=t2] run tag @s add stats_sort
execute if entity @a[tag=stats_sort] run function ut:system/stats/sort
execute as @a[team=t3] run tag @s add stats_sort
execute if entity @a[tag=stats_sort] run function ut:system/stats/sort
execute as @a[team=t4] run tag @s add stats_sort
execute if entity @a[tag=stats_sort] run function ut:system/stats/sort
execute as @a[team=t5] run tag @s add stats_sort
execute if entity @a[tag=stats_sort] run function ut:system/stats/sort
execute as @a[team=t6] run tag @s add stats_sort
execute if entity @a[tag=stats_sort] run function ut:system/stats/sort
execute as @a[team=t7] run tag @s add stats_sort
execute if entity @a[tag=stats_sort] run function ut:system/stats/sort
execute as @a[team=t8] run tag @s add stats_sort
execute if entity @a[tag=stats_sort] run function ut:system/stats/sort
# boss
execute as @a[team=boss] run tag @s add stats_sort
execute if entity @a[tag=stats_sort] run function ut:system/stats/sort
execute as @a[team=nosoul] run tag @s add stats_sort
execute if entity @a[tag=stats_sort] run function ut:system/stats/sort