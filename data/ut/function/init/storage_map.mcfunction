...
data modify storage ut:maps Data append value {Id:12,Type:"team",Name:{"translate":"las.map.core"},PlayWith:{"translate":"las.map.count","with":[4,8]},StructureBlock:{"name":"ut:mini_core"},Creator:"SY91419",Border:{Speed:[250,250],Size:[600,120]}}
...
data modify storage ut:maps Data append value {Id:9,Type:"team",Name:{"translate":"las.map.sans"},PlayWith:{"translate":"las.map.count","with":[21,652]},StructureBlock:{"name":"ut:mini_sans"},StructureLocked:{"name":"ut:mini_sans_locked"},Creator:"Ehdanrary",Border:{Speed:[250,250],Size:[480,133]}}
