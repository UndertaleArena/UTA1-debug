...
item replace block 255 0 255 container.0 with minecraft:carrot_on_a_stick[minecraft:custom_model_data={floats:[102]},minecraft:lore=[{"text":""},{"translate":"itm.spare1","italic":false,"color":"white"},{"translate":"itm.spare2","italic":false,"color":"white"},{"translate":"itm.spare3","italic":false,"color":"white"}],minecraft:attribute_modifiers=[{amount:-10.0d,operation:"add_value",slot:"mainhand",type:"attack_damage",id:"nomelee"}],minecraft:custom_name={"translate":"itm.spare","italic":false,"bold":true},minecraft:custom_data={sp_move:1b,spare:1b},minecraft:tooltip_display={hidden_components:["attribute_modifiers"]}]
