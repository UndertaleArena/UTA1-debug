...
item replace entity @e[tag=summon] armor.head with bowl[custom_model_data={floats:[1]}]
...
item replace entity @e[tag=summon] armor.head with bowl[custom_model_data={floats:[2]}]
