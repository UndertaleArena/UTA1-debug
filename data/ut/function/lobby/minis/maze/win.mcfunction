...
summon firework_rocket ~ ~ ~ {LifeTime:14,FireworksItem:{id:"minecraft:firework_rocket",count:1,components:{fireworks:{flight_duration:0,explosions:[{shape:"small_ball",has_twinkle:0b,has_trail:0b,colors:[2437522],fade_colors:[12801229]}]}}}}