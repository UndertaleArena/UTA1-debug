...
summon minecraft:armor_stand ^ ^ ^ {Tags:[nokill,ak_bullet,woodaxe,summon,cmove,credit_as],NoGravity:1b,Invisible:1b,Marker:1b,Invulnerable:1b,equipment:{head:{id:"minecraft:wooden_axe",count:1b,components:{"minecraft:custom_model_data":{floats:[1]}}}},Pose:{Head:[230f,1f,0f]},CustomName:{"translate":"chr.ak.mpn1"},Rotation:[99f,0.0f]}
