...
summon minecraft:husk ^ ^ ^ {Tags:[prep,move,gb,gb_skull,summon,spc],NoGravity:1b,Invulnerable:1b,NoAI:1b,equipment:{head:{id:"minecraft:bone_meal",count:1b}},Silent:1b,DeathLootTable:"",CustomNameVisible:0b,Team:"nocol",Glowing:1b}
