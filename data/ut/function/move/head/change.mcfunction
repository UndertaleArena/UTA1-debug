...
execute if entity @s[tag=counter_dodgep] run data modify block 255 0 255 Items[0].id set value "minecraft:tropical_fish"
...
execute if score @s[tag=undying] chr matches 3 run data modify block 255 0 255 Items[0].components.minecraft:custom_model_data.floats[0] set value 3
