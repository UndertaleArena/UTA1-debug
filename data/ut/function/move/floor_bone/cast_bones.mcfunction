...
summon minecraft:armor_stand ~ ~ ~ {Tags:[floor_bone,prj,prj_sp,summon,move],NoGravity:1b,Invisible:1b,Marker:1b,Invulnerable:1b,equipment:{head:{id:"minecraft:light_gray_dye",count:1b}},Pose:{Head:[0f,0f,0f]},CustomName:{"translate":"chr.papyrus.dtn"}}
