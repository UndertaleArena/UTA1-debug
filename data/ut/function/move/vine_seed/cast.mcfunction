...
data merge entity @e[tag=summon,limit=1] {Tags:[vine_seed,inair,motion_prj,prj2,move,summon],NoGravity:1b,Silent:1b,NoAI:1b,Team:"nocol",IsBaby:1b,equipment:{head:{id:"minecraft:wheat_seeds",count:1b}}}
###SETUP ENTITY
