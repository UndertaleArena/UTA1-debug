...
###SUMMON ENTITY
summon minecraft:armor_stand ^0.0 ^-0.2 ^0.0 {Tags:[fireball_buffed,killonhit,blockable,reflectable,cutable,prj2,move,summon],NoGravity:1b,Invisible:1b,Marker:1b,equipment:{head:{id:"minecraft:fire_charge",count:1b}},CustomName:{"translate":"chr.toriel.mpnb"}}
###SETUP ENTITY
