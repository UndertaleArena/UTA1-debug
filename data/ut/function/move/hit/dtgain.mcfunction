...
execute if score #degainflag dt matches 1.. run scoreboard players operation #gain dt /= 5 const
execute if score #degainflag dt matches 1.. run scoreboard players operation #gain dt *= 4 const
