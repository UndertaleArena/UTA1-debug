...
attribute @s movement_speed modifier remove ghostspeed
attribute @s knockback_resistance modifier remove ghostkbr
...
execute if entity @s[tag=effect_impaled] run function ut:move/effect/impaled/update
...
execute if items entity @s armor.head *[custom_data~{Armors:[{},{},{}]}] run function ut:move/ghost/reset_armor
