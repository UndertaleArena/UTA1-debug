...
execute if score @s pid = #atker nid run scoreboard players set #check hitcheck 0
execute if score #check hitcheck matches 1 run function ut:move/counter/check
execute if score #check hitcheck matches 2 run function ut:move/firehand_ball/hit