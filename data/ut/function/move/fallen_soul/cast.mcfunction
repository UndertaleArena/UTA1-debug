...
summon minecraft:armor_stand ~ ~50 ~ {Tags:[fallen_soul,summon,move,spc],NoGravity:1b,NoBasePlate:1b,Invisible:1b,Marker:1b,equipment:{head:{id:"carrot_on_a_stick",count:1,components:{custom_model_data:{floats:[1010]}}}},CustomName:"Falling Soul",Small:1b}
