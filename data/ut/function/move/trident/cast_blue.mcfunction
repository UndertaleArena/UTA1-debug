...
data merge entity @e[tag=summon,limit=1] {Tags:[summon,move,prj_sp,trident,trident_blue],NoGravity:1b,Invulnerable:1b,Silent:1b,NoAI:1b,equipment:{chest:{id:"minecraft:slime_ball",count:1b,components:{"minecraft:custom_data":{hit_list:[]}}}},CustomNameVisible:0b,Team:"nocol"}
