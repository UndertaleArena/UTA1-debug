...
summon minecraft:armor_stand ^ ^ ^3 {Tags:[pellet_tut,spc,summon,move,summon_rotate],NoGravity:1b,Invisible:1b,Marker:1b,Invulnerable:1b,Pose:{Head:[0f,0f,0f]},CustomName:{"translate":"chr.flowey.mpn"}}
