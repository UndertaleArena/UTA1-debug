...
data merge entity @e[tag=summon,limit=1] {Tags:[summon,move,web,web_land,prj,prj_sp],NoGravity:1b,Invulnerable:1b,Silent:1b,Marker:1b,equipment:{head:{id:"minecraft:purple_dye",count:1b}},Pose:{Head:[0f,0f,0f]},CustomName:"Spider Web"}
