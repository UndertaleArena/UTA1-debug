...
data merge entity @e[tag=summon,limit=1] {Tags:[web,killonhit,stickonhit,blockable,reflectable,cutable,web_prj,motion_prj,prj2,move,summon],NoGravity:1b,Silent:1b,NoAI:1b,Team:"nocol",IsBaby:1b,equipment:{head:{id:"minecraft:string",count:1b}}}
###SETUP ENTITY
