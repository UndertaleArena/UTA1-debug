...
execute at @s run summon minecraft:armor_stand ~ ~ ~ {Tags:[summon,move,vine_center,landed,prj,prj_sp,no_direction],NoGravity:1b,Invulnerable:1b,Silent:1b,Marker:1b,Pose:{Head:[0f,0f,0f]},CustomName:{"translate":"chr.flowey.dtn"}}
