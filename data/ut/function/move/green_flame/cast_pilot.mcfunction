...
summon minecraft:armor_stand ^ ^ ^ {Tags:[summon,summon_gf,move,green_flame,prj,prj_sp,green_flame_kill],NoGravity:1b,Invisible:1b,Marker:1b,Invulnerable:1b,CustomName:{"translate":"chr.toriel.dtn"},equipment:{chest:{id:"minecraft:slime_ball",count:1b,components:{"minecraft:custom_data":{hit_list:[]}}}}}
