...
#check on this
summon minecraft:armor_stand ^ ^ ^ {Tags:[summon,summon_gf,prj_sp,move,green_flame_bullet,green_flame_kill],NoGravity:1b,Invisible:1b,Marker:1b,Invulnerable:1b,equipment:{head:{id:"minecraft:book",count:1b}},Pose:{Head:[0f,0f,0f]}}
