...
particle dust{color:[1.0,0.0,0.0],scale:1.5} ~ ~1.5 ~ 0.3 1 0.3 0 150 normal @a[scores={Q=2..}]
particle dust{color:[1.0,0.0,0.0],scale:1.2} ~ ~1.5 ~ 0.15 1.5 0.15 0 150 force @a[scores={Q=1..}]
