...
give @s minecraft:carrot_on_a_stick[minecraft:custom_model_data={floats:[104]},minecraft:lore=[{"translate":"dsc.mwmove","italic":false,"color":"red"},{"text":""},{"translate":"chr.chara.mwx1","italic":false,"color":"white"}],minecraft:attribute_modifiers=[],minecraft:enchantments={"minecraft:knockback":3},minecraft:custom_name={"translate":"chr.chara.mwxn","color":"red","italic":false,"bold":true},minecraft:custom_data={real_knife_knife:1b},tooltip_display={hidden_components:["attribute_modifiers","enchantments"]}]

###
scoreboard players set @s plt3 120
scoreboard players set @s unloadtime_3rd 120
