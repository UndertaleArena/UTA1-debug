...
execute if score #check hitcheck matches 2 positioned as @s positioned ~ ~1 ~ as @e[tag=atker,limit=1] rotated as @s positioned ^ ^ ^-1 run function ut:move/gear/explode