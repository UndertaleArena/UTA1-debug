...
#vip
summon turtle 277.5 137 1271.5 {Silent:1b,PersistenceRequired:1b,Invulnerable:1b,CustomName:{"text":"Master KALM","color":"dark_purple","bold":true},Tags:["staff","no_panik","vip"],home_pos:[I;277,136,1271]}
...
summon chicken 269.5 148 1295.5 {Silent:1b,Invulnerable:1b,ForcedAge:1,Age:-24000,PersistenceRequired:1b,Tags:["pokemon","staff","farfetchd","active","ray_target"], equipment:{mainhand:{id:"minecraft:bamboo",count:1b,components:{"minecraft:custom_name":"Green Onion"}}},CustomName:"little duck"}

#tv
summon painting 273.0 142 1292.0 {Invulnerable:1b,Tags:["staff","tv"],CustomName:"tv_main",variant: "minecraft:fighters",facing:0b}

summon armor_stand 275.0 142.7 1292.0 {Small:1b,Marker:1b,Invisible:1b,Tags:["staff","tv"],CustomName:"tv_sans",equipment:{head:{id:"minecraft:nether_brick",count:1b,components:{"minecraft:custom_name":"sans","minecraft:custom_model_data":{floats:[1]}}}},Rotation:[30.0f,0.0f]}

summon armor_stand 273.1 142.5 1292.0 {Small:1b,Marker:1b,Invisible:1b,Tags:["staff","tv"],CustomName:"tv_papy",equipment:{head:{id:"minecraft:nether_brick",count:1b,components:{"minecraft:custom_name":"papy","minecraft:custom_model_data":{floats:[2]}}}},Rotation:[-30.0f,0.0f]}
...
#temz
summon cat 252.5 143 1274.5 {NoAI:1b,NoGravity:1b,Invulnerable:1b,PersistenceRequired:1b,Silent:1b,Sitting:1b,variant:"minecraft:tabby",Tags:["staff","tem"],Rotation:[-90.0f,0.0f],CustomName:"Tem"}

summon cat 252.5 143 1272.5 {NoAI:1b,NoGravity:1b,Invulnerable:1b,PersistenceRequired:1b,Silent:1b,Sitting:1b,variant:"minecraft:tabby",Tags:["staff","tem"],Rotation:[-90.0f,0.0f],CustomName:"Tem"}

summon cat 252.5 143 1270.5 {NoAI:1b,NoGravity:1b,Invulnerable:1b,PersistenceRequired:1b,Silent:1b,Sitting:1b,variant:"minecraft:tabby",Tags:["staff","tem"],Rotation:[-90.0f,0.0f],CustomName:"Tem"}

summon cat 252.5 143 1268.5 {NoAI:1b,NoGravity:1b,Invulnerable:1b,PersistenceRequired:1b,Silent:1b,Sitting:1b,variant:"minecraft:tabby",Tags:["staff","tem","bob"],Rotation:[-90.0f,0.0f],CustomName:"Bob"}
...
summon snow_golem 257.5 141.75 1265.5 {NoGravity:1b,NoAI:1b,Invulnerable:1b,PersistenceRequired:1b,Pumpkin:0b,Tags:["staff","tem","woa"],CustomName:"Tem Statu",Rotation:[0.0f,0.0f]}
